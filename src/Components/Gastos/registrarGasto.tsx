...
function RegistrarGasto({isOpen, onOpenChange, fetchGastos}: {
    isOpen: boolean,
    ...
    const handleRegistrar = () => {
        ...
        const fechaIngresada = new Date(parseInt(ano), parseInt(mes) - 1, parseInt(dia)); //Se crea una fecha con la fecha ingresada
