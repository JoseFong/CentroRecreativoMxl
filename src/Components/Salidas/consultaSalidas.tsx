...
export default function App({docentes, grupos, salidasRegistradas, refetch}: ConsultaSalidasProps) {
        ...
        <div>
            <Popover placement="bottom">
                ...
                <PopoverContent>
                    ...
                    <div className=" my-2">
                        <RegistrarSalida esRegistro={true} docentes={docentes} grupos={grupos} refetch={refetch}/>
                    </div>
                </PopoverContent>
            </Popover>
        </div>
