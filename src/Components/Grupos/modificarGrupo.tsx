...
import ConfirmarEliminarGrupo from "./confirmarEliminarGrupo";
...
function ModificarGrupo({
    ...
    const [isConfirmarModificarOpen, setIsConfirmarModificarOpen] = useState(false);
    ...
    const handleModificar = () => {
        ...
        if (selectedGrupo) {
            ...
            setIsConfirmarModificarOpen(true);
        }
    };
        ...
        selectedGrupo && (
            <Modal isOpen={isOpen} onOpenChange={onOpenChange} placement="center">
                <ModalContent>
                    ...
                    <ModalFooter>
                        <Button className={"bg-red-800"} onClick={handleEliminar}>
                            Eliminar
                        </Button>
                ...
                <ConfirmarModificarGrupo
                    data={data}
                    isOpen={isConfirmarModificarOpen}
                    modificarOpenChange={onOpenChange}
                    onOpenChange={setIsConfirmarModificarOpen}
                ...
                <ConfirmarEliminarGrupo
                    ...
                    eliminarOpenChange={onOpenChange}
                    onOpenChange={setIsConfirmarEliminarOpen}
                    fetchGrupos={fetchGrupos}
                    fetchAlumnos={fetchAlumnos}
                />
            </Modal>
