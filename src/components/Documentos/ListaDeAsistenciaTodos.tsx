  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.subtitle}>Todos los grupos</Text>
      </View>
...
function ListaDeAsistenciaTodos({ grupo, alumnos, isOpen, onOpenChange }: any) {
...
export default ListaDeAsistenciaTodos;
